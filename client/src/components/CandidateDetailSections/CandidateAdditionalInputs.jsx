...
const CandidateAdditionalInputs = ({ userData, setUserData }) => {
  // Initialize the fields to prevent "undefined" errors
  ...
  const additionalInputs = userData.additionalInputs;
  ...
  const handleRemoveItem = (type, id) => {
    setUserData((prev) => ({
      ...
      additionalInputs: {
        ...additionalInputs,
        [type]: additionalInputs[type].filter((item) => item.id !== id),
      },
    }));
  };
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-[#0077b6]">
        Showcase Your additionalInputs
      </h1>
      <div className="overflow-y-auto">
        ...
        <section className="my-6">
          ...
          {additionalInputs.projects.map((project) => (
            <div
              key={project.id}
            ...
            >
              <Typography>
                ...
                Skills Utilized: {project.skills}
              </Typography>
        ...
        <section className="my-6">
          ...
          {additionalInputs.publications.map((pub) => (
            <div
              key={pub.id}
            ...
            >
              ...
              <Tooltip title="Remove">
                <IconButton
                  onClick={() => handleRemoveItem("publications", pub.id)}
                >
                  <Delete color="error" />
                </IconButton>
              </Tooltip>
